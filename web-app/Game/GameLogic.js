...
const PROPERTY_DATA = {
    ...
    2: { name: "Huxley", type: "property", price: 150, upgradeCost: 50, rent: [0, 8, 30, 60, 180], colourGroup: "brown", description: "Huxley Building" },
    ...
    5: { name: "Blackett", type: "property", price: 120, upgradeCost: 50, rent: [6, 12, 30, 90, 270], colourGroup: "light_blue", description: "Blackett Laboratory" },
    6: { name: "Event Card", type: "event", price: 0, rent: [0], colourGroup: null, description: "Draw an Event Card." },
    7: { name: "Roderic Hill", type: "property", price: 140, upgradeCost: 50, rent: [8, 16, 40, 100, 300], colourGroup: "light_blue", description: "Roderic Hill" },
    ...
    10: { name: "Sir Alexander Fleming Building", type: "property", price: 160, upgradeCost: 100, rent: [10, 20, 50, 150, 450], colourGroup: "pink", description: "Sir Alexander Fleming Building." },
    11: { name: "Business School", type: "property", price: 180, upgradeCost: 100, rent: [12, 24, 60, 180, 500], colourGroup: "pink", description: "Imperial College Business School." },
    12: { name: "Event Card", type: "event", price: 0, rent: [0], colourGroup: null, description: "Draw an Event Card." },
    13: { name: "Ace Workshop", type: "property", price: 200, upgradeCost: 100, rent: [14, 28, 70, 200, 550], colourGroup: "orange", description: "The Design Engineering Workshop." },
    14: { name: "Dyson Building", type: "property", price: 220, upgradeCost: 100, rent: [16, 32, 80, 220, 600], colourGroup: "orange", description: "The One and Only Dyson School of Design Engineering." },
    15: { name: "Free Parking", type: "free_parking", price: 0, rent: [0], colourGroup: null, description: "Rest here. Nothing happens." },
    16: { name: "Sherfield Walkway", type: "property", price: 240, upgradeCost: 150, rent: [18, 36, 90, 250, 700], colourGroup: "red", description: "Walkway with all the food you need." },
    17: { name: "Event Card", type: "event", price: 0, rent: [0], colourGroup: null, description: "Draw an Event Card." },
    18: { name: "Abdus Salam Library", type: "property", price: 260, upgradeCost: 150, rent: [20, 40, 100, 300, 750], colourGroup: "red", description: "The Central Library." },
    19: { name: "Eastbound Station", type: "station", price: 200, rent: [100, 200], colourGroup: "station", description: "Take the shuttle service to the other campus." },
    20: { name: "Hammersmith Hospital", type: "property", price: 280, upgradeCost: 150, rent: [22, 44, 110, 330, 800], colourGroup: "yellow", description: "Hammersmith campus" },
    21: { name: "Charing Cross Hospital", type: "property", price: 300, upgradeCost: 150, rent: [24, 48, 120, 360, 850], colourGroup: "yellow", description: "Charing Cross campus" },
    22: { name: "You Fail", type: "go_to_jail", price: 0, rent: [0], colourGroup: null, description: "Go directly to Gap Year!" },
    23: { name: "White City Campus", type: "property", price: 320, upgradeCost: 200, rent: [26, 52, 130, 390, 900], colourGroup: "green", description: "White City campus." },
    24: { name: "Natural History Museum", type: "property", price: 320, rent: [10, 20], colourGroup: "Museums", description: "Bones and Old Stuff" },
    25: { name: "Queens Tower", type: "property", price: 340, upgradeCost: 200, rent: [28, 56, 150, 450, 1000], colourGroup: "green", description: "THE Queen's Tower" },
    ...
    28: { name: "Royal Albert Hall", type: "property", price: 400, upgradeCost: 200, rent: [100, 200, 600, 1400], colourGroup: "dark_blue", description: "The crown jewel of Kensington." }
};
